 ...
 *
 * The route emails the enquiry to support@theshorewood.com and sends the
 * visitor an automatic confirmation.
 *
 * Fields: Full Name · Contact Number · Email · Message
 */
...
function Label({ htmlFor, children, required }) {
  return (
    <label htmlFor={htmlFor} className="text-[14px] font-medium text-[#191919]">
      {children}
  ...
  if (status === "sent") {
    return (
      ...
      >
        ...
        <p className="max-w-[460px] text-[15px] leading-[1.6] text-[#545454]">
          We&rsquo;ve sent a confirmation to{" "}
          <span className="text-[#191919]">{sentTo}</span> and a trip designer
          will reply within one working day.
        </p>

        <p className="text-[13px] leading-[1.6] text-[#7D7D7D]">
          Nothing in your inbox in a few minutes? Check the spam folder, or
          write to{" "}
          <a
            href="mailto:support@theshorewood.com"
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        />
        {errors.name && (
          <p className="text-[13px] text-[#BA2525]">{errors.name}</p>
        )}
      </div>
      ...
      <div className="grid w-full gap-7 sm:grid-cols-2">
        <div className="flex w-full flex-col gap-2">
          ...
          />
          {errors.phone && (
            <p className="text-[13px] text-[#BA2525]">{errors.phone}</p>
          )}
        </div>
        ...
        <div className="flex w-full flex-col gap-2">
          ...
          />
          {errors.email && (
            <p className="text-[13px] text-[#BA2525]">{errors.email}</p>
          )}
        </div>
      </div>
